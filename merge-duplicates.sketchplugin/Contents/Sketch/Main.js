...
module.exports = "file://" + String(context.scriptPath).split(".sketchplugin/Contents/Sketch")[0] + ".sketchplugin/Contents/Resources/_webpack_resources/1de4374f9d34519eabe9aad77b935e74.html";
...
module.exports = "file://" + String(context.scriptPath).split(".sketchplugin/Contents/Sketch")[0] + ".sketchplugin/Contents/Resources/_webpack_resources/c86b4a93211fd119c91311ce3f13f65d.html";
...
module.exports = "file://" + String(context.scriptPath).split(".sketchplugin/Contents/Sketch")[0] + ".sketchplugin/Contents/Resources/_webpack_resources/3addb721449b8470019e650a932706bb.html";
...
module.exports = "file://" + String(context.scriptPath).split(".sketchplugin/Contents/Sketch")[0] + ".sketchplugin/Contents/Resources/_webpack_resources/59fc73646995e58e17cd1c678de252b5.html";
...
module.exports = "file://" + String(context.scriptPath).split(".sketchplugin/Contents/Sketch")[0] + ".sketchplugin/Contents/Resources/_webpack_resources/fd3923fe2a67ff191ff4ea546e9451aa.html";
...
module.exports = "file://" + String(context.scriptPath).split(".sketchplugin/Contents/Sketch")[0] + ".sketchplugin/Contents/Resources/_webpack_resources/67859c5d3ff97bb634dc2f6fae836707.html";
...
module.exports = "file://" + String(context.scriptPath).split(".sketchplugin/Contents/Sketch")[0] + ".sketchplugin/Contents/Resources/_webpack_resources/d66b70a12949d0f25f7da1d3fad97485.html";
...
module.exports = "file://" + String(context.scriptPath).split(".sketchplugin/Contents/Sketch")[0] + ".sketchplugin/Contents/Resources/_webpack_resources/0582316f1edaabf3bd662ce5aed2cb9c.html";
...
module.exports = "file://" + String(context.scriptPath).split(".sketchplugin/Contents/Sketch")[0] + ".sketchplugin/Contents/Resources/_webpack_resources/33d25cff8f57cfe3f74bc0746262fe38.html";
...
function FindSimilarTextStyles(referenceStyle, styles, context, checkSameFont, checkSameWeight, checkSameSize, checkSameColor, checkSameParagraphSpacing, checkSameLineHeight, checkSameAlignment, checkSameCharacterSpacing) {
  ...
  styles.forEach(function (style) {
    if (referenceStyle != style.textStyle) {
      ...
      var sameFont = referenceStyle.style().textStyle().attributes().NSFont.familyName() == style.textStyle.style().textStyle().attributes().NSFont.familyName(); //console.log("---Font? "+sameFont);

      var sameWeight = NSFontManager.sharedFontManager().weightOfFont_(referenceStyle.style().textStyle().attributes().NSFont) == NSFontManager.sharedFontManager().weightOfFont_(style.textStyle.style().textStyle().attributes().NSFont); //console.log("---FontWeight? "+sameWeight);

      var sameSize = referenceStyle.style().textStyle().attributes().NSFont.pointSize() == style.textStyle.style().textStyle().attributes().NSFont.pointSize(); //console.log("---FontSize? "+sameSize);
      ...
      var sameColor = referenceStyle.style().textStyle().attributes().MSAttributedStringColorAttribute.hexValue() == style.textStyle.style().textStyle().attributes().MSAttributedStringColorAttribute.hexValue(); //console.log("---Color? "+sameColor);

      var sameParagraphSpacing = referenceStyle.style().textStyle().attributes().NSParagraphStyle.paragraphSpacing() == style.textStyle.style().textStyle().attributes().NSParagraphStyle.paragraphSpacing(); //console.log("---Paragraph Spacing? "+sameParagraphSpacing);

      var sameLineHeight = referenceStyle.style().textStyle().attributes().NSParagraphStyle.minimumLineHeight() == style.textStyle.style().textStyle().attributes().NSParagraphStyle.minimumLineHeight(); //console.log("---Line height? "+sameLineHeight);

      var sameAlignment = referenceStyle.style().textStyle().attributes().NSParagraphStyle.alignment() == style.textStyle.style().textStyle().attributes().NSParagraphStyle.alignment(); //console.log("---Alignment? "+sameAlignment);
...
function getDuplicateSymbols(context, selection, includeAllSymbolsFromExternalLibraries, mergingSelected) {
  ...
  selection.forEach(function (symbol) {
    ...
    if (recomposedSymbolName.localeCompare("Button/Secondary/_Regular/_Secondary") == 0) {//console.log("Local symbol '" + symbolObject.name + "'. Foreign:" + symbolObject.isForeign);
      //console.log(symbol);
    }
...
/*!*********************!*\
  !*** ./src/Main.js ***!
  \*********************/
/*! exports provided: MergeDuplicateSymbols, MergeSelectedSymbols, MergeSelectedTextStyles, MergeSimilarTextStyles, MergeDuplicateTextStyles, MergeSelectedLayerStyles, MergeSimilarLayerStyles, MergeDuplicateLayerStyles, triggerMethod, showRegistration, onShutdown */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
